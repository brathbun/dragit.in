...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'post_max_size' => 'Image is larger than 4mb',
        'max_file_size' => 'Image is too big',
        'min_file_size' => 'Image is too small',
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
            ...
            'database' => 'dragitin_db',
            'host' => 'localhost',
            'username' => 'dragitinuser76',
            'password' => 'RBBCPVSxwpVPmD4C',
    ...
    protected function get_file_objects($iteration_method = 'get_file_object') {
        ...
        //Uncomment this to keep user uploads visible
    ...
    protected function trim_file_name($name, $type, $index, $content_range) {
        ...
        $file_name = '';
        for ($p = 0; $p < $length; $p++) {
           $file_name .= $characters[mt_rand(0, strlen($characters))];
        }
    ...
    $add_to_db = $this->query("INSERT INTO images VALUES ('','$whichimg','$ip','$host','$browser','$referrer',now()) ") or die(mysql_error());
    return $add_to_db;
    }
    ...
    {
    $delete_from_db = $this->query("DELETE FROM images WHERE img_name = '$delimg'") or die(mysql_error());
